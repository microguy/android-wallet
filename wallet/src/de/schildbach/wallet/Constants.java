...
public final class Constants {
    ...
    public static final String DONATION_ADDRESS = NETWORK_PARAMETERS.getId().equals(NetworkParameters.ID_MAINNET)
            ? "EANsCgwjCx5A2eFToeyHHCE11mnwuf6HAW" : null;
    ...
    public static final String SOURCE_URL = "https://github.com/Stouse49/goldcoin-wallet";
    public static final String BINARY_URL = "https://github.com/Stouse49/goldcoin-wallet/releases";
